...
"intro_demo": {
        ...
        Tutti i testi sono in italiano o inglese, a seconda della tua scelta. Le tue risposte saranno salvate in modo anonimo per scopi di ricerca.\n\n_**DISCLAIMER**_: I testi sono originariamente in inglese, pertanto alcune traduzioni potrebbero non risultare perfettamente naturali in italiano. Se possiedi una buona conoscenza della lingua inglese, è consigliato leggere il testo originale.\n\nPrima di iniziare, inserisci alcune informazioni statistiche.""",
        ...
        All texts are in Italian or English, depending on your choice. Your answers will be saved anonymously for research purposes.\n\n_**DISCLAIMER**_: All texts were originally written in English. Therefore, the Italian versions might be less accurate/natural. If you are fluent in English, we recommend selecting the English version.\n\nBefore starting, please provide some demographic information."""
    },
    "age": {"it": "Età", "en": "Age"},
