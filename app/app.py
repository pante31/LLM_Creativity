...
"intro_demo": {
        ...
        Tutti i testi sono in italiano o inglese, a seconda della tua scelta. Le tue risposte saranno salvate in modo anonimo per scopi di ricerca.\n\n_DISCLAIMER_: I testi sono originariamente in inglese, pertanto alcune traduzioni potrebbero non risultare perfettamente naturali in italiano. Se possiedi una buona conoscenza della lingua inglese, è consigliato leggere il testo originale.\nPrima di iniziare, inserisci alcune informazioni statistiche.""",
