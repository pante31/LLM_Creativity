...
T = {
    ...
    **Scopo della ricerca:** Questo studio mira a confrontare la valutazione umana di testi scritti con le valutazioni generate da sistemi di Intelligenza Artificiale (LLM), al fine di analizzare l'allineamento tra giudizio umano e sintetico.
    ...
    **Purpose of Research:** This study aims to compare human evaluation of written texts with evaluations generated by Artificial Intelligence systems (LLMs), investigating the alignment between human and synthetic judgment.
    
    **Procedure:** You will be asked to read short texts and evaluate them using numerical scales. Basic demographic information (age, gender, education) and your level of experience with Large Language Models will also be requested.
    
    **Anonymity and Open Science:** Participation is completely anonymous. No names, IP addresses, or other personal identifiers will be recorded. 
    In line with "Open Science" principles, the anonymized data will be stored indefinitely and may be made **publicly available** to the scientific community as a dataset for future research.
